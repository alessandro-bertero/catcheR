...
dir.create(file.path("Output","CARDIO","SIDE1"))
dir.create(file.path("Output","CARDIO","SIDE1","monocle"))#create forders cardio MONOCLE
dir.create(file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d")))
dir.create(file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "R_objects"))
dir.create(file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "dotplots"))
dir.create(file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "dotplots","single"))
dir.create(file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "stat"))
dir.create(file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "csv"))
dir.create(file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "UMAP"))
dir.create(file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "mosaic"))

fname_scratch <- file.path("Output","scratch")


#set up forder path MONOCLE CARDIO
fname_prefix_R_c <- file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "R_objects", 
                               format(Sys.Date(), "%y%m%d"))
fname_prefix_dotplot_c <- file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "dotplots", 
                                                 format(Sys.Date(), "%y%m%d"))
fname_prefix_dotplot_single_c <- file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "dotplots", "single", 
                                                 format(Sys.Date(), "%y%m%d"))
fname_prefix_csv_c<-file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "csv", 
                               format(Sys.Date(), "%y%m%d"))
fname_prefix_stat_c<-file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "stat", 
                               format(Sys.Date(), "%y%m%d"))
fname_prefix_UMAP_c<-file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "UMAP", 
                               format(Sys.Date(), "%y%m%d"))
fname_prefix_mosaic_c<-file.path("Output","CARDIO","SIDE1","monocle", format(Sys.Date(), "%y%m%d"), "mosaic", 
                               format(Sys.Date(), "%y%m%d"))
...
cds=cds[,cds$side=="Side1"]
cds_cardio=cds_cardio[,cds_cardio$side=="Side1"]

meta=subset(meta,meta$side=="Side1")
meta_cardio=subset(meta_cardio,meta_cardio$side=="Side1")
...
Rdata_filename = paste0(fname_prefix_R_c, "_monocle_cds_D6_D12_D23_renamed_pseudotime_FINAL_SIDE1.RData")
...
ggplot(m6, aes(x = factor(cell_type_short, levels = order_cell_types), y = frxn, fill=factor(gene,levels=c(order_genes_2)))) + geom_bar(stat = "identity") +
  scale_fill_okabeito(name="genes",order=c(7,1,2,3,4,5))+
...
```
########## NB.following steps are not possible due to the low amount of cells in side 1 for all genes, but especially B2M
####################################################################################################
