#' @title catcheR_cell_filtering
#' @description Cell filtering step of the data analysis pipeline for the iPS2-seq methods from HEDGe lab.
...
#'\dontrun{
#'
#' catcheR_cell_filtering(group = "docker", folder = "/20tb/ratto/catcheR/test_CM5/", expression.matrix = "matrix.csv", UMI_count = 10, 15)
#'
#' @export
...
catcheR_cell_filtering <- function(
  ...
  params <- paste("--cidfile ",folder,"/dockerID -v ",folder, ":/data/scratch -d docker.io/repbioinfo/catcher_barcode_pipeline /home/barcode_silencing_cell_filtering.R /data/scratch ",percentage," ",UMI.count, " ", expression.matrix, sep="")
