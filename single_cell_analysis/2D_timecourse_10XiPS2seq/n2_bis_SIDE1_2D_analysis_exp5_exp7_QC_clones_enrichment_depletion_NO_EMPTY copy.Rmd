...
dir.create(file.path("Output","monocle","no_empty","SIDE1"))
dir.create(file.path("Output","monocle","no_empty","SIDE1",  format(Sys.Date(), "%y%m%d")))
dir.create(file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "R_objects"))
dir.create(file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "dotplots"))
dir.create(file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "dotplots","single"))
dir.create(file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "stat"))
dir.create(file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "csv"))
dir.create(file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "UMAP"))
dir.create(file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "mosaic"))
dir.create(file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "line"))

fname_scratch <- file.path("Output","scratch")

#set up forder path MONOCLE
fname_prefix_R <- file.path("Output","monocle","no_empty","SIDE1",format(Sys.Date(), "%y%m%d"), "R_objects", 
                               format(Sys.Date(), "%y%m%d"))
fname_prefix_dotplot <- file.path("Output","monocle","no_empty","SIDE1",format(Sys.Date(), "%y%m%d"), "dotplots", 
                                                 format(Sys.Date(), "%y%m%d"))
fname_prefix_dotplot_single <- file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "dotplots", "single", 
                                                 format(Sys.Date(), "%y%m%d"))
fname_prefix_csv<-file.path("Output","monocle","no_empty","SIDE1",format(Sys.Date(), "%y%m%d"), "csv", 
                               format(Sys.Date(), "%y%m%d"))
fname_prefix_stat<-file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "stat", 
                               format(Sys.Date(), "%y%m%d"))
fname_prefix_UMAP<-file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "UMAP", 
                               format(Sys.Date(), "%y%m%d"))
fname_prefix_mosaic<-file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "mosaic", 
                               format(Sys.Date(), "%y%m%d"))
fname_prefix_line<-file.path("Output","monocle","no_empty","SIDE1", format(Sys.Date(), "%y%m%d"), "line", 
                               format(Sys.Date(), "%y%m%d"))
...
cds_side1= cds[,cds@colData@listData[["side"]]=="Side1"]
meta_s1=as.data.frame(cds_side1@colData@listData)


clone_counts=meta_s1 %>%
...
meta_s1=meta_s1%>%right_join(clone_counts,by="clone")
row.names(meta_s1)=meta_s1$info

cds_side1@colData$clone_selection=meta_s1$has_20_counts#add info to CDS file

cds_side1 <- cds_side1[,cds_side1@colData@listData[["clone_selection"]]==T] #from 36244 to 36019
meta_s1=as.data.frame(cds_side1@colData@listData)

m0=subset(meta_s1, meta$DD=="D0")


Rdata_filename = paste0(fname_prefix_R, "_side1.RData")
save(cds_side1,meta_s1,m0,
     file = Rdata_filename)
...
cc_ex5=cc_ex5%>%left_join(B2M_counts_e5, by="experiment")%>%left_join(t_e5, by="experiment")
...
cc_ex5=cc_ex5%>%dplyr::rename(D0_ex5=D0,
                              D0B2M_ex5=D0B2M,D0_TOT_ex5=D0_TOT,D23_TOT_ex5=D23_TOT,
                              clone_fraction_hiPSC_ex5=clone_fraction_hiPSC,
                              clone_fraction_hiPSC_B2M_ex5=clone_fraction_hiPSC_B2M)%>%dplyr::select(-experiment)
#####21 clones
...
cc_ex7=cc_ex7%>%left_join(B2M_counts_e7, by="experiment")%>%left_join(t_e7, by="experiment")###43 clones
...
cc_ex7=cc_ex7%>%dplyr::rename(D0_ex7=D0,
                              D0B2M_ex7=D0B2M,D0_TOT_ex7=D0_TOT,D2_TOT_ex7=D2_TOT,D6_TOT_ex7=D6_TOT,D12_TOT_ex7=D12_TOT,
                              clone_fraction_hiPSC_ex7=clone_fraction_hiPSC,
                              clone_fraction_hiPSC_B2M_ex7=clone_fraction_hiPSC_B2M)%>%dplyr::select(-experiment)
###21 clones
cc=cc_ex7%>%full_join(cc_ex5, by="clone")###21
FC_df=cc%>%dplyr::select(-D0_ex7,-D0_ex5,-D0B2M_ex7,-D0B2M_ex5,-D0_TOT_ex7,-D0_TOT_ex5,-D2_TOT_ex7,-D6_TOT_ex7,-D12_TOT_ex7,-D23_TOT_ex5,-D12,-D2,-D6,-D12B2M,-D2B2M,-D6B2M,-D23,-D23B2M)
...
result_df_DD23 <- data.frame(clone = clone_names, P_value_B2M = p_values_B2M)

result_df_DD23=result_df_DD23%>%dplyr::mutate(qval_DD23_B2M=p.adjust(result_df_DD23$P_value_B2M,method = "BH"))
result_df_DD23=result_df_DD23%>%dplyr::select(clone, qval_DD23_B2M)
...
# Create the result data frame
result_df_DD2 <- data.frame(clone = clone_names, P_value_B2M = p_values_B2M)

result_df_DD2=result_df_DD2%>%dplyr::mutate(qval_DD2_B2M=p.adjust(result_df_DD2$P_value_B2M,method = "BH"))
result_df_DD2=result_df_DD2%>%dplyr::select(clone, qval_DD2_B2M)
...
# Create the result data frame
result_df_DD6 <- data.frame(clone = clone_names, P_value_B2M = p_values_B2M)

result_df_DD6=result_df_DD6%>%dplyr::mutate(qval_DD6_B2M=p.adjust(result_df_DD6$P_value_B2M,method = "BH"))
result_df_DD6=result_df_DD6%>%dplyr::select(clone, qval_DD6_B2M)
...
# Create the result data frame
result_df_DD12 <- data.frame(clone = clone_names, P_value_B2M = p_values_B2M)

result_df_DD12=result_df_DD12%>%dplyr::mutate(qval_DD12_B2M=p.adjust(result_df_DD12$P_value_B2M,method = "BH"))%>%dplyr::select(clone, qval_DD12_B2M)
...
ggplot(data=FC_df, aes(x=log2(clone_fraction_D23vshiPSC_B2M), y=(log2(clone_fraction_hiPSC_B2M_ex5)))) +
  geom_point(aes(colour = log10(qval_DD23_B2M)*-1, size=1.5)) +
  scale_color_viridis(name = "-log10(adj p-value)",
                         option="E", discrete=F)+
  #scale_colour_manual(values = pal)+
  #geom_text(aes(label=to_show_2vsother), size=4, hjust=1.2)+
  ggrepel::geom_text_repel(
    data = subset(FC_df,FC_df$qval_DD23_B2M<=0.05&log2(FC_df$clone_fraction_D23vshiPSC_B2M)>1|FC_df$qval_DD23_B2M<=0.05&log2(FC_df$clone_fraction_D23vshiPSC_B2M)*-1>1.5),
 ...
 # geom_vline(xintercept = c(fc_level, fc_level2))
  ggtitle("Clone enrichment depletion D23 compared to B2M")+
...
ggsave(filename = paste0(fname_prefix_dotplot, "_enrichment_depletion_D23_B2M.pdf"),
       width = 5, height = 4)

###D2

ggplot(data=FC_df, aes(x=log2(clone_fraction_D2vshiPSC_B2M), y=(log2(clone_fraction_hiPSC_B2M_ex7)))) +
  geom_point(aes(colour = log10(qval_DD2_B2M)*-1, size=1.5)) +
  scale_color_viridis(name = "-log10(adj p-value)",
                         option="E", discrete=F)+
  #scale_colour_manual(values = pal)+
  #geom_text(aes(label=to_show_2vsother), size=4, hjust=1.2)+
  ggrepel::geom_text_repel(
    data = subset(FC_df,FC_df$qval_DD2_B2M<=0.05&log2(FC_df$clone_fraction_D2vshiPSC_B2M)>1|FC_df$qval_DD2_B2M<=0.05&log2(FC_df$clone_fraction_D2vshiPSC_B2M)*-1>1.5),
    aes(label = shRNA_label),
    size = 3,
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.3, "lines")
  ...
  xlim(-4,2)+
 # geom_vline(xintercept = c(fc_level, fc_level2))
  ggtitle("Clone enrichment depletion D2 compared to B2M")+
  theme_minimal() +  # You can change the theme as needed
  labs(
...
ggsave(filename = paste0(fname_prefix_dotplot, "_enrichment_depletion_D2_B2M.pdf"),
       width = 5, height = 4)

###D6

ggplot(data=FC_df, aes(x=log2(clone_fraction_D6vshiPSC_B2M), y=(log2(clone_fraction_hiPSC_B2M_ex7)))) +
  geom_point(aes(colour = log10(qval_DD6_B2M)*-1, size=1.5)) +
  scale_color_viridis(name = "-log10(adj p-value)",
                         option="E", discrete=F)+
  #scale_colour_manual(values = pal)+
  #geom_text(aes(label=to_show_2vsother), size=4, hjust=1.2)+
  ggrepel::geom_text_repel(
    data = subset(FC_df,FC_df$qval_DD6_B2M<=0.05&log2(FC_df$clone_fraction_D6vshiPSC_B2M)>1|FC_df$qval_DD6_B2M<=0.05&log2(FC_df$clone_fraction_D6vshiPSC_B2M)*-1>1.5),
    aes(label = shRNA_label),
    size = 3,
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.3, "lines")
  ...
  xlim(-4,2)+
 # geom_vline(xintercept = c(fc_level, fc_level2))
  ggtitle("Clone enrichment depletion D6 compared to B2M")+
  theme_minimal() +  # You can change the theme as needed
  labs(
...
ggsave(filename = paste0(fname_prefix_dotplot, "_enrichment_depletion_D6_B2M.pdf"),
       width = 5, height = 4)

###D12

ggplot(data=FC_df, aes(x=log2(clone_fraction_D12vshiPSC_B2M), y=(log2(clone_fraction_hiPSC_B2M_ex7)))) +
  geom_point(aes(colour = log10(qval_DD12_B2M)*-1, size=1.5)) +
  scale_color_viridis(name = "-log10(adj p-value)",
                         option="E", discrete=F)+
  #scale_colour_manual(values = pal)+
  #geom_text(aes(label=to_show_2vsother), size=4, hjust=1.2)+
  ggrepel::geom_text_repel(
    data = subset(FC_df,FC_df$qval_DD12_B2M<=0.05&log2(FC_df$clone_fraction_D12vshiPSC_B2M)>1|FC_df$qval_DD12_B2M<=0.05&log2(FC_df$clone_fraction_D12vshiPSC_B2M)*-1>1.5),
    aes(label = shRNA_label),
    size = 3,
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.3, "lines")
  ...
  xlim(-4,2)+
 # geom_vline(xintercept = c(fc_level, fc_level2))
  ggtitle("Clone enrichment depletion D12 compared to B2M")+
  theme_minimal() +  # You can change the theme as needed
  labs(
...
ggsave(filename = paste0(fname_prefix_dotplot, "_enrichment_depletion_D12_B2M.pdf"),
       width = 5, height = 4)
...
ggplot(data=subset(FC_df,log2(FC_df$clone_fraction_D23vshiPSC)>=-3), aes(x=log2(clone_fraction_D23vshiPSC), y=(log2(clone_fraction_hiPSC_ex5)))) +
  geom_point(aes(colour = log10(qval_DD23_TOTAL)*-1, size=1.5)) +
  scale_color_viridis(name = "-log10(adj p-value)",
                         option="E", discrete=F,limits = c(0, 7))+
  #scale_colour_manual(values = pal)+
  #geom_text(aes(label=to_show_2vsother), size=4, hjust=1.2)+
  ggrepel::geom_text_repel(
    data = subset(FC_df,FC_df$qval_DD23_TOTAL<=0.05),
    aes(label = shRNA_label),
    size = 3,
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.3, "lines")
...
ggplot(data=FC_df, aes(x=log2(clone_fraction_D2vshiPSC), y=(log2(clone_fraction_hiPSC_ex7)))) +
  ...
  #geom_text(aes(label=to_show_2vsother), size=4, hjust=1.2)+
  ggrepel::geom_text_repel(
    data = subset(FC_df,FC_df$qval_DD2_TOTAL<=0.05),max.overlaps =20,
    aes(label = shRNA_label),
    size = 3,
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.3, "lines")
...
ggplot(data=FC_df, aes(x=log2(clone_fraction_D6vshiPSC), y=(log2(clone_fraction_hiPSC_ex7)))) +
  ...
  #geom_text(aes(label=to_show_2vsother), size=4, hjust=1.2)+
  ggrepel::geom_text_repel(
    data = subset(FC_df,FC_df$qval_DD6_TOTAL<=0.05&log2(FC_df$clone_fraction_D6vshiPSC)>=1|FC_df$qval_DD6_TOTAL<=0.05&log2(FC_df$clone_fraction_D6vshiPSC)*-1>=1),max.overlaps =20,
    aes(label = shRNA_label),
    size = 3,
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.3, "lines"),
...
ggplot(data=FC_df, aes(x=log2(clone_fraction_D12vshiPSC), y=(log2(clone_fraction_hiPSC_ex7)))) +
  ...
  #geom_text(aes(label=to_show_2vsother), size=4, hjust=1.2)+
  ggrepel::geom_text_repel(
    data = subset(FC_df,FC_df$qval_DD12_TOTAL<=0.05),max.overlaps =20,
    aes(label = shRNA_label),
    size = 3,
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.3, "lines")
...
```
#####overall clone depletion percentage calculated over the total of B2M

```{r}

FC_B2M=FC_df%>%
  dplyr::select(shRNA_label,hex,col_name,shRNA_gene,clone_fraction_D2vshiPSC_B2M,clone_fraction_D6vshiPSC_B2M,clone_fraction_D12vshiPSC_B2M,clone_fraction_D23vshiPSC_B2M)%>%
  dplyr::rename(D2=clone_fraction_D2vshiPSC_B2M,D6=clone_fraction_D6vshiPSC_B2M,D12=clone_fraction_D12vshiPSC_B2M,D23=clone_fraction_D23vshiPSC_B2M)%>%
  mutate(D0=1)
FC_B2M=FC_B2M %>%gather(key=timepoint, value=percent_vs_hPSC, D0, D2, D6, D12,D23, na.rm = FALSE, convert = FALSE)
FC_B2M=FC_B2M %>%left_join(side, by="clone")
genes= unique(FC_B2M$shRNA_gene)

smad2_FC_B2M=subset(FC_B2M,FC_B2M$shRNA_gene=="SMAD2")
gata4_FC_B2M=subset(FC_B2M,FC_B2M$shRNA_gene=="GATA4")
KMT2D_FC_B2M=subset(FC_B2M,FC_B2M$shRNA_gene=="KMT2D")
CHD7_FC_B2M=subset(FC_B2M,FC_B2M$shRNA_gene=="CHD7")
NKX25_FC_B2M=subset(FC_B2M,FC_B2M$shRNA_gene=="NKX2.5")
...
ggplot(smad2_FC_B2M,aes(x=factor(timepoint,levels=c("D0","D2","D6","D12","D23")),y=percent_vs_hPSC,color=shRNA_label))+
  geom_line(aes(group=clone))+
  #scale_linetype_manual(name="side",values = c("dashed", "solid","longdash"))+
  scale_color_oi(order = c(1, 5, 6, 2, 4, 3, 7))+
  geom_line(data = mean,mapping = aes(x = timepoint, y = average, group=1), 
  ...
  labs(
    ...
    y = "clone fraction vs hiPSC",
    color = "shRNA",
    title= "Depletion of SMAD2 clones compared to B2M"
  ) 

ggsave(filename = paste0(fname_prefix_line, "_enrichment_depletion_SMAD2_B2M.pdf"),
       width = 5, height = 4)
...
ggplot(gata4_FC_B2M,aes(x=factor(timepoint,levels=c("D0","D2","D6","D12","D23")),y=percent_vs_hPSC,color=shRNA_label))+
  geom_line(aes(group=clone))+
  #scale_linetype_manual(name="side",values = c("dashed", "solid","longdash"))+
  scale_color_oi(order = c(1, 5, 6, 2, 4, 3, 7))+
  geom_line(data = mean,mapping = aes(x = timepoint, y = average, group=1), 
  ...
  labs(
    ...
    y = "clone fraction vs hiPSC",
    color = "shRNA",
    title= "Depletion of GATA4 clones compared to B2M"
  )
ggsave(filename = paste0(fname_prefix_line, "_enrichment_depletion_GATA4_B2M.pdf"),
       width = 5, height = 4)
...
ggplot(CHD7_FC_B2M,aes(x=factor(timepoint,levels=c("D0","D2","D6","D12","D23")),y=percent_vs_hPSC,color=shRNA_label))+
  geom_line(aes(group=clone))+
  #scale_linetype_manual(name="side",values = c("solid","longdash"))+
  scale_color_oi(order = c(1, 5, 6, 2, 4, 3, 7))+
  geom_line(data = mean,mapping = aes(x = timepoint, y = average, group=1), 
  ...
  labs(
    ...
    y = "clone fraction vs hiPSC",
    color = "shRNA",
    title= "Depletion of CHD7 clones compared to B2M"
  )
ggsave(filename = paste0(fname_prefix_line, "_enrichment_depletion_CHD7_B2M.pdf"),
       width = 5, height = 4)
...
ggplot(KMT2D_FC_B2M,aes(x=factor(timepoint,levels=c("D0","D2","D6","D12","D23")),y=percent_vs_hPSC,color=shRNA_label))+
  geom_line(aes(group=clone))+
  #scale_linetype_manual(name="side",values = c("solid","longdash"))+
  scale_color_oi(order = c(1, 5, 6, 2, 4, 3, 7))+
  geom_line(data = mean,mapping = aes(x = timepoint, y = average, group=1), 
  ...
  labs(
    ...
    y = "clone fraction vs hiPSC",
    color = "shRNA",
    title= "Depletion of KMT2D clones compared to B2M"
  )
ggsave(filename = paste0(fname_prefix_line, "_enrichment_depletion_KMT2D_B2M.pdf"),
       width = 5, height = 4)
...
ggplot(NKX25_FC_B2M,aes(x=factor(timepoint,levels=c("D0","D2","D6","D12","D23")),y=percent_vs_hPSC,color=shRNA_label))+
  geom_line(aes(group=clone))+
  #scale_linetype_manual(name="side",values = c("solid","longdash"))+
  scale_color_oi(order = c(9, 5, 6, 2, 4, 3, 7))+
  geom_line(data = mean,mapping = aes(x = timepoint, y = average, group=1), 
  ...
  labs(
    ...
    y = "clone fraction vs hiPSC",
    color = "shRNA",
    title= "Depletion of NKX2.5 clones compared to B2M"
  )
ggsave(filename = paste0(fname_prefix_line, "_enrichment_depletion_NKX25_B2M.pdf"),
       width = 5, height = 4)
...
Side1=percent_hiPSC%>%filter(percent=="percentSide1")
Side1=Side1[order(Side1$value,decreasing = T),]
clone_order=Side1$clone

s1clones=side%>%filter(side=="Side1")
s1clones=as.vector(unique(s1clones$clone))

percent_hiPSC=percent_hiPSC%>%filter(clone%in%s1clones)
...
```
###make clone plots for sides and depletion/enrichment
####clone fraction based on total of B2M
...
ggplot(FC_df, aes(x = factor(clone,levels = clone_order), y = log2(clone_fraction_D2vshiPSC_B2M), fill=shRNA_gene))+ geom_bar(stat = "identity")+
  scale_fill_okabeito()+
  geom_hline(yintercept = -1, linetype="dotted")+
  ylim(-4,2)+
  labs(
    ...
    y = "Log2 of clone fraction in hiPSC CM D2 vs hiPSC",
    color = "shRNA",
    title= "Enrichment Depletion at D2 compared to B2M")
ggsave(filename = paste0(fname_prefix_mosaic, "_", "enrichment_depletion_D2_B2M.pdf"),
     width = 6, height = 8)

ggplot(FC_df, aes(x = factor(clone,levels = clone_order), y = log2(clone_fraction_D6vshiPSC_B2M), fill=shRNA_gene))+ geom_bar(stat = "identity")+
  scale_fill_okabeito()+
  geom_hline(yintercept = -1, linetype="dotted")+
  ylim(-4,2)+
  labs(
    ...
    y = "Log2 of clone fraction in hiPSC CM D6 vs hiPSC",
    color = "shRNA",
    title= "Enrichment Depletion at D6 compared to B2M")

ggsave(filename = paste0(fname_prefix_mosaic, "_", "enrichment_depletion_D6_B2M.pdf"),
     width = 6, height = 8)

ggplot(FC_df, aes(x = factor(clone,levels = clone_order), y = log2(clone_fraction_D12vshiPSC_B2M), fill=shRNA_gene))+ geom_bar(stat = "identity")+
  scale_fill_okabeito()+
  geom_hline(yintercept = -1, linetype="dotted")+
  ylim(-4,2)+
  labs(
    ...
    y = "Log2 of clone fraction in hiPSC CM D12 vs hiPSC",
    color = "shRNA",
    title= "Enrichment Depletion at D12 compared to B2M")

ggsave(filename = paste0(fname_prefix_mosaic, "_", "enrichment_depletion_D12_B2M.pdf"),
     width = 6, height = 8)

ggplot(FC_df, aes(x = factor(clone,levels = clone_order), y = log2(clone_fraction_D23vshiPSC_B2M), fill=shRNA_gene))+ geom_bar(stat = "identity")+
  scale_fill_okabeito()+
  geom_hline(yintercept = -1, linetype="dotted")+
  ylim(-4,2)+
  labs(
    ...
    y = "Log2 of clone fraction in hiPSC CM D23 vs hiPSC",
    color = "shRNA",
    title= "Enrichment Depletion at D23 compared to B2M")

ggsave(filename = paste0(fname_prefix_mosaic, "_", "enrichment_depletion_D23_B2M.pdf"),
     width = 6, height = 8)
```
#######add clone names
