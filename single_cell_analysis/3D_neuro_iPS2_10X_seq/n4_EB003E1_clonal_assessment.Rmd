...
m=as.data.frame(colData(cds))
tot_cluster_counts=m%>%
  dplyr::group_by(assigned_cell_type,assigned_cell_type_short,monocle_clusters) %>%
  dplyr::summarise(count = n())%>%mutate(frequency = 100*count/sum(count))

stat_filename = paste0(fname_prefix_stat, "_NEURO_CLUSTERS_FREQUENCY.csv")
write.csv(tot_cluster_counts, stat_filename, quote = F, row.names = T, sep=",")
...
clone_counts_complete=clone_counts_complete%>%left_join(clones, by="clone")
...
show=c("PAX6","TYRP1","EMX2","NEUROD1","CACNA1A","TUBB3","SB100B","OLIG3","OTX2","SIX3","EOMES","FOXC1","NFIX")

show_cortical_neuro=c("EMX2","NEUROD1","EOMES","TBR2","MASH1","MASH2","NFIX")
...
ggsave(filename = paste0(fname_prefix_dotplot, "_", "neuro_genes_show.pdf"),
     width = 6, height = 5)

plot_cells(cds,
           genes = show_cortical_neuro,
            label_cell_groups = FALSE,
            show_trajectory_graph = FALSE)+ 
     labs(x = "UMAP 1", y = "UMAP 2", title = "")+
     scale_color_viridis(option="E", discrete=F)

ggsave(filename = paste0(fname_prefix_dotplot, "_", "neuro_genes_cortical.pdf"),
     width = 5, height = 4)
...
ggplot(by_gene_KD, aes(x =factor(cell_types_abbreviations,levels=c("NoN","Fib","PRP","REP","RPE","subCor","CorP","CorARG","CorGlutP","NC","Astro","Neuro")), y = frxn, fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +theme(legend.position='none')+
  ...
  facet_grid(~KD~factor(gene, levels = gene_order))+ labs(x = "% gene by treatment", y = "cluster")
...
ggplot(by_gene_KD, aes(x = KD, y = frxn, fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +
  scale_fill_manual(values =color_df_s$cl_col)+
  facet_wrap(~factor(gene, levels = gene_order), ncol=4)+ labs(x = "treatment", y = "% gene by treatment")
...
ggplot(by_gene_KD_ratio, aes(x =factor(cell_types_abbreviations,levels=c("NoN","Fib","PRP","REP","RPE","subCor","CorP","CorARG","CorGlutP","NC","Astro","Neuro")), y = log2(FC), fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +theme(legend.position='none')+
  ...
  geom_hline(yintercept=-1, linetype="dashed", color = "red")+
  scale_fill_manual(values =color_df_s$cl_col)+
  facet_grid(~factor(gene, levels = gene_order))+ labs(x = "cluster", y = "log2 (% gene KD vs CTR)")
...
ggplot(by_gene_KD, aes(x = factor(cell_types_abbreviations,levels=c("NoN","Fib","PRP","REP","RPE","subCor","CorP","CorARG","CorGlutP","NC","Astro","Neuro")), y = frxn, fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +theme(legend.position='none')+
  ...
  facet_grid(~KD~factor(gene, levels = gene_order))+ labs(x = "cluster", y = "% gene by treatment")
...
ggplot(data=subset(by_side_KD,by_side_KD$side=="iPSC-neuro"|by_side_KD$side=="iPSC"), aes(x = factor(cell_types_abbreviations,levels=c("NoN","Fib","PRP","REP","RPE","subCor","CorP","CorARG","CorGlutP","NC","Astro","Neuro")), y = frxn, fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +theme(legend.position='none')+
  scale_fill_manual(values =color_df_s_p$cl_col)+
  facet_grid(~KD~side)+ labs(x = "cluster", y = "% side by treatment")
...
ggplot(data=subset(by_side_KD,by_side_KD$side=="iPSC-neuro"|by_side_KD$side=="iPSC"), aes(x = KD, y = frxn, fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +
  scale_fill_manual(values =color_df_s_p$cl_col)+
  facet_wrap(~side, ncol=4)+ labs(x = "treatment", y = "% side by treatment")
...
ggplot(data=subset(by_side_KD,by_side_KD$side=="iPSC-neuro"|by_side_KD$side=="iPSC"), aes(x = side, y = frxn, fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +
  scale_fill_manual(values =color_df_s_p$cl_col)+
  facet_wrap(~KD, ncol=4)+ labs(x = "side", y = "% cells")
...
ggplot(data=subset(by_side_KD_ratio,by_side_KD_ratio$side=="iPSC-neuro"|by_side_KD_ratio$side=="iPSC"), aes(x = factor(cell_types_abbreviations,levels=c("NoN","Fib","PRP","REP","RPE","subCor","CorP","CorARG","CorGlutP","NC","Astro","Neuro")), y = log2(FC), fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +theme(legend.position='none')+
  ...
  geom_hline(yintercept=-1, linetype="dashed", color = "red")+
  scale_fill_manual(values =color_df_s_p$cl_col)+
  facet_grid(~side)+ labs(x = "cluster", y = "log2 (% side KD vs CTR)")
...
ggplot(data=by_side_ratio, aes(x = factor(cell_types_abbreviations,levels=c("NoN","Fib","PRP","REP","RPE","subCor","CorP","CorARG","CorGlutP","NC","Astro","Neuro")), y = log2(FC), fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +theme(legend.position='none')+
  ...
  geom_hline(yintercept=-1, linetype="dashed", color = "red")+
  scale_fill_manual(values =color_df_s_p$cl_col)+
  facet_grid(~KD)+ labs(x = "cluster", y = "log2 (% side iPSC-neuro vs iPSC)")
...
ggplot(gene_KD_all_side, aes(x = KD, y = frxn, fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +
  scale_fill_manual(values =color_df_s_p$cl_col)+
  facet_wrap(~factor(gene_pol, levels = c("Control","CHD7","GATA4","KMT2D","NKX2.5","SMAD2")), ncol=3)+ labs(x = "treatment", y = "% gene by treatment")
...
####side 1 is iPSC derived and Side 2 is iPSC-neuro derived
...
gene_list_selection=c("SMAD2","CHD7","KMT2D")
combined_result_df_SELECTION=subset(combined_result_df,combined_result_df$gene%in%gene_list_selection)
combined_result_df_SELECTION$q_value=p.adjust(combined_result_df_SELECTION$p_value, method = "fdr")
combined_result_df_S1=combined_result_df
combined_result_df_SELECTION_S1=combined_result_df_SELECTION
...
ggplot(data=combined_result_df_SELECTION, aes(x=log2(as.numeric(FC)), y=log10(q_value)*-1)) +
  geom_point(aes(colour = factor(cell_types_abbreviations,levels=c("NoN","Fib","PRP","REP","RPE","subCor","CorP","CorARG","CorGlutP","NC","Astro","Neuro"))), size=1.5) +scale_colour_manual(values=color_df_polished$colors)+
  ggrepel::geom_text_repel(
    data = subset(combined_result_df_SELECTION, combined_result_df_SELECTION$sig==T&combined_result_df_SELECTION$FC>2|combined_result_df_SELECTION$sig==T&combined_result_df_SELECTION$FC<0.5),
    aes(label = gene),
    size = 3,
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.3, "lines"),
...
ggsave(filename = paste0(fname_prefix_dotplot, "_volcano_fisher_stats_side1_selected_genes.pdf"),
       width = 5, height = 4)


ggplot(data=combined_result_df_S1, aes(x = factor(cell_types_abbreviations,levels=c("NoN","Fib","PRP","REP","RPE","subCor","CorP","CorARG","CorGlutP","NC","Astro","Neuro")), y = log2(FC), fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +theme(legend.position='none')+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  geom_hline(yintercept=-1, linetype="dashed", color = "red")+
  scale_fill_manual(values =color_df_s_p$cl_col)+
  facet_grid(~factor(gene, levels = gene_order))+ labs(x = "cluster", y = "log2 (% gene KD vs CTR)")
...
ggplot(data=subset(combined_result_df_S1,combined_result_df_S1$gene%in%gene_list_selection), aes(x = factor(cell_types_abbreviations,levels=c("NoN","Fib","PRP","REP","RPE","subCor","CorP","CorARG","CorGlutP","NC","Astro","Neuro")), y = log2(FC), fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +theme(legend.position='none')+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  geom_hline(yintercept=-1, linetype="dashed", color = "red")+
  scale_fill_manual(values =color_df_s_p$cl_col)+
  facet_grid(~factor(gene, levels = gene_order))+ labs(x = "cluster", y = "log2 (% gene KD vs CTR)")
ggsave(filename = paste0(fname_prefix_mosaic, "_", "FC_cells_clust_polished_side1_selected_genes.pdf"),
     width = 16, height = 4)
...
ggplot(data=subset(gene_KD_side1,gene_KD_side1$gene%in%gene_list_selection), aes(x = KD, y = frxn, fill=cell_types_abbreviations)) + geom_bar(stat = "identity") +
  scale_fill_manual(values =color_df_s_p$cl_col)+
  facet_wrap(~factor(gene_pol, levels = c("Control","CHD7","GATA4","KMT2D","NKX2.5","SMAD2")), ncol=3)+ labs(x = "treatment", y = "% gene by treatment")
output_file <- paste0(fname_prefix_mosaic, "_", "percent_by_gene_by_side1_selected_genes.pdf")
ggsave(filename = output_file, width = 10, height = 8)
...
by_shRNA_KD=m
#add cluster info
by_shRNA_KD$monocle_cluster=as.integer(as.character(by_shRNA_KD$monocle_cluster))
by_shRNA_KD=by_shRNA_KD%>%left_join(clust_df, by="monocle_cluster")

by_shRNA_KD$monocle_clusters=as.character(by_shRNA_KD$monocle_cluster)
...
FC=CTR%>%dplyr::left_join(KD,by=c("gene","shRNA","monocle_cluster", "cell_types","cell_types_abbreviations","colors","monocle_clusters"))
...
combined_result_sh_df$monocle_cluster=as.character(combined_result_sh_df$monocle_cluster)

ggplot(data=subset(combined_result_sh_df,!is.na(combined_result_sh_df$gene)), aes(x=log2(as.numeric(FC)), y=log10(q_value)*-1)) +
  geom_point(aes(colour = cell_types_abbreviations), size=1.5) +scale_colour_manual(values=color_df_s_p$colors)+
  ggrepel::geom_text_repel(
...
combined_result_sh_df_selected=subset(combined_result_sh_df,combined_result_sh_df$gene%in%gene_list_selection)

combined_result_sh_df_selected$q_value==p.adjust(combined_result_sh_df_selected$p_value, method = "fdr")

ggplot(data=subset(combined_result_sh_df_selected,!is.na(combined_result_sh_df_selected$gene)), aes(x=log2(as.numeric(FC)), y=log10(q_value)*-1)) +
  geom_point(aes(colour = cell_types_abbreviations), size=1.5) +scale_colour_manual(values=color_df_s_p$colors)+
  ggrepel::geom_text_repel(
    data = subset(combined_result_sh_df_selected, sig==T),
    aes(label = shRNA),
    size = 3,
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.3, "lines")
...
ggsave(filename = paste0(fname_prefix_dotplot, "_volcano_fisher_stats_shRNA_side1_selected.pdf"),
       width = 6, height = 4)
...
info=meta%>%select(shRNA_gene,clone,shRNA_label,monocle_clusters)%>%distinct(shRNA_gene,clone,shRNA_label,monocle_clusters)%>%mutate(cluster=paste0("clust",monocle_clusters))

i=info%>%left_join(clones, by=c("clone", "shRNA_gene"))
...
color_df_s_p$monocle_cluster=as.character(color_df_s_p$monocle_cluster)
combined_result_cl_df=combined_result_cl_df%>%left_join(color_df_s_p, by=c("monocle_clusters"="monocle_cluster"))

combined_result_cl_df=combined_result_cl_df%>%left_join(clones, by=c("clone", "shRNA_gene"))
combined_result_cl_df$clone_short=paste0(combined_result_cl_df$shRNA_ID_unified,"_",combined_result_cl_df$cl_ID)

combined_result_cl_df_selected=subset(combined_result_cl_df,combined_result_cl_df$shRNA_gene%in%gene_list_selection)

combined_result_cl_df_selected$q_value=p.adjust(combined_result_cl_df_selected$p_value, method = "fdr")
...
ggplot(data=combined_result_cl_df_selected, aes(x=log2(as.numeric(FC)), y=log10(q_value)*-1)) +
  geom_point(aes(colour = cell_types_abbreviations), size=1.5) +scale_colour_manual(values=color_df_s_p$colors)+
  ggrepel::geom_text_repel(
    data = subset(combined_result_cl_df_selected, sig==T),
    aes(label = clone_short),
    size = 3,
    max.overlaps=20,
    box.padding = unit(0.35, "lines"),
...
ggsave(filename = paste0(fname_prefix_dotplot, "_volcano_fisher_stats_clone_selected.pdf"),
       width = 6, height = 4)
