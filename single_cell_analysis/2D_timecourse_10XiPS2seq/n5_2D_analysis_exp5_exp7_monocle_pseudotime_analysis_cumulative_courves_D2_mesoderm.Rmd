...
dir.create(file.path("Output","Meso","monocle", format(Sys.Date(), "%y%m%d"), "cumulative"))
...
fname_prefix_dotplot <- file.path("Output","Meso","monocle", format(Sys.Date(), "%y%m%d"), "dotplots", 
                                                 format(Sys.Date(), "%y%m%d"))
fname_prefix_cumulative <- file.path("Output","Meso","monocle", format(Sys.Date(), "%y%m%d"), "cumulative", 
                                                 format(Sys.Date(), "%y%m%d"))
